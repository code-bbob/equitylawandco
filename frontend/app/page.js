        ...
        <div className=" mx-auto px-6 sm:px-6 lg:px-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            <ScrollFadeIn slideDistance={70} duration={1100}>
              <div>
                <span className="text-xs font-semibold text-amber-700 tracking-widest uppercase inline-block hover-scale">About Equity Law & Co.</span>
            ...
            <ScrollFadeIn slideDistance={70} duration={1200} scale={true}>
              <div className="bg-amber-700 h-64 md:h-96 rounded-lg shadow-md hover:shadow-2xl flex items-center justify-center text-white text-center relative overflow-hidden transition-all duration-500 hover-glow">
                ...
                <div className="relative z-10">
                  <div className="text-5xl md:text-6xl font-bold mb-3 animate-float">27+</div>
